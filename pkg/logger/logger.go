...
type Configuration struct {
	EnableConsole     bool   `name:"log-enable-console" help:"Enable log console" env:"LOG_ENABLE_CONSOLE" default:"true"`
	ConsoleJSONFormat bool   `name:"log-console-json-format" help:"Console to json format" env:"LOG_CONSOLE_JSON_FORMAT" default:"false"`
	ConsoleLevel      string `name:"log-console-level" help:"Console log level" env:"LOG_CONSOLE_LEVEL" default:"info" enum:"debug, info, warn, error, fatal, panic"`
	EnableFile        bool
	FileJSONFormat    bool
	FileLevel         string
	FileLocation      string
...
//go:generate mockery --case underscore --name=Logger --inpackage --filename=logger_mock.go
